	...
	public Frejmb11DodavanjeLeka(String jmbgLekar) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (Unos){
					JOptionPane.showMessageDialog(null, "Uspešno ste uneli lek");
					dispose();
					Frejm2GlavniMeni Dodat = new Frejm2GlavniMeni(jmbgLekar);
					Dodat.setVisible(true);
				}
				} catch (Exception e) {
					JOptionPane.showMessageDialog(null, "Greška prilikom unosa molimo Vas ponovo unesite podatke", "Greška", JOptionPane.ERROR_MESSAGE);
